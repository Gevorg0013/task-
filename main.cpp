...
{
	size_t max_lenght_rown, max_lenght_column, rown, column;
...
//	std::vector<std::vector<int>> x(70, std::vector<int>(76));
	...
	std::vector<std::vector<std::pair<int, bool>>>x(70, std::vector<std::pair<int, bool>>(78));
	...
	char c;
	std::cout << "\n\nnow to input operator throught character-";
	std::cin >> c;
